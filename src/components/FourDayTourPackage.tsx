...
const FourDayTourPackage = () => {
  ...
  const itinerary = [
    { day: 1, title: 'Colombo / Galle, Bentota / Yala', activities: ['Bentota River Safari', 'Galle Fort Tour', 'Hikkaduwa Beach Visit', 'Mask Museum'] },
    { day: 2, title: 'Yala / Ella', activities: ['Yala National Park Safari', 'Mini Adams Peak Hike', 'Ravana Falls Visit', 'Nine Arch Bridge'] },
    { day: 3, title: 'Ella / Nuwara Eliya / Kandy', activities: ['Hill Country Train Journey', 'Tea Factory Visit', 'Ramboda Waterfall', 'Nuwara Eliya City Tour'] },
    { day: 4, title: 'Kandy / Colombo', activities: ['Temple of the Tooth', 'Royal Botanical Garden', 'Kandy City Tour', 'Spice Garden Visit'] }
  ];
