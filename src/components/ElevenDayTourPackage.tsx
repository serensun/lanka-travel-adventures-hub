...
import { Clock, Users, Globe, Calendar, CheckCircle, XCircle, AlertCircle, ZoomIn, ChevronLeft, ChevronRight, ChevronDown, ChevronUp, Car, MapPin, DollarSign } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Twin/Double</TableHead>
            ...
            {/* Booking Form */}
            <BookingForm 
              packageType="Sri Lanka 11-days tour, Insight Into Sri Lanka"
              travelers={2}
              totalCost={packageRates.standard.double * 2}
              initialComments=""
            />
          </div>
        </div>
