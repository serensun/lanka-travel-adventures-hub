...
const ThreeDayTourPackage = () => {
  ...
  const packageRates = {
    standard: { double: 399, single: 599 },
    comfort: { double: 499, single: 799 },
    luxury: { double: 699, single: 899 }
  };
  ...
  const galleryImages = [
    {
      ...
      caption: 'Explore the sacred city of Anuradhapura with its magnificent dagobas'
    },
    {
      url: gallery2,
    ...
    },
    {
      ...
      caption: 'Discover the ancient ruins of Polonnaruwa'
    },
    {
      url: gallery4,
      alt: 'Dambulla Cave Temple',
      caption: 'Visit the magnificent Dambulla Golden Cave Temple'
    },
    {
      url: gallery5,
    ...
    },
    {
      ...
      caption: 'See ancient religious monuments and Buddha statues'
    }
  ];
  ...
  const inclusions = [
    ...
    'Entrance fees for The Sigiriya Rock Fortress, Sigiriya paintings, and the Sigiriya museum',
    'Dambulla Golden Cave Temple, Polonnaruwa historical city and historical museum',
    'Sacred Tooth Relic Temple, Kandyan cultural show',
    'The spice garden comes with a serving of herbal drink',
    ...
    'A driver or guide who speaks English will be available for the entire tour',
    'All current taxes'
  ];
    ...
    <div className="space-y-8">
      <div className="text-center space-y-4">
        <h2 className="text-4xl font-bold text-blue-900 mb-4">
          3-Day Sri Lanka Cultural Triangle Mini Tour
        </h2>
        <p className="text-xl text-blue-700 max-w-4xl mx-auto">
          Discover UNESCO treasures, climb the iconic Sigiriya Rock Fortress, and explore ancient cities in this compact cultural adventure.
        </p>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 h-fit border border-blue-200">
          ...
          <div className="space-y-4">
            ...
            <BookingForm 
              packageType={`3-day-cultural-triangle-mini-tour-${selectedPackage}`}
              travelers={travelers}
